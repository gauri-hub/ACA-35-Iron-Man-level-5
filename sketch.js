...
var score =0;
//function to load all the game assets
function preload() {
...
function draw() {
  ...
  //mario scale =0.3; 
    ...
    //mario.scale =0.3;
    //to scroll background infinitely
    if (bg.y > 500){
      bg.y=bg.width/4;
    }
    //keyboard controls
...
//call the function to generate spikes
    generateSpikes();
// make iron man step(collide) on spikes
...
//to prevent the iron man falling down
